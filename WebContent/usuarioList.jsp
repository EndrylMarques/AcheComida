...
<tr>
 ...
 <td> <a href="/acheComida/usuarios?q=editar&id=${e.id}">${e.nome} </a></td>
 <td> ${e.email} </td> 
 <td> ${e.telefone} </a></td>
 
 <td> <a href="/acheComida/usuarios?q=excluir&id=${e.id}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a> </td>
